...
export default function ConversionsPage() {
  ...
  useEffect(() => {
    getCurrentUser()
      .then(u => { setUserEmail(u.signInDetails?.loginId ?? ""); setConversions(getStoredConversions()); })
  ...
  return (
    <div style={{ minHeight: "100vh", background: C.base, fontFamily: "Inter, system-ui, sans-serif", color: C.text, display: "flex", flexDirection: "column" }}>
      ...
      <main style={{ flex: 1, maxWidth: 1100, width: "100%", margin: "0 auto", padding: "48px 48px 64px" }}>
        ...
        <div style={{ background: "#fff", borderRadius: 16, boxShadow: "0 4px 24px rgba(83,74,183,0.05)", overflow: "hidden" }}>
          ...
          {/* Table header */}
          <div style={{ display: "grid", gridTemplateColumns: "2fr 1fr 1fr 1fr", padding: "14px 28px", borderBottom: "0.5px solid #F4F3FB" }}>
          ...
          {conversions.map((c, i) => (
            <div key={c.id}
              style={{ display: "grid", gridTemplateColumns: "2fr 1fr 1fr 1fr", padding: "20px 28px", alignItems: "center", borderBottom: i < conversions.length - 1 ? "0.5px solid #F8F7FF" : "none" }}>
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
                ...
                <div>
                  <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 6 }}>
                    <span style={{ fontSize: 14, fontWeight: 500, color: C.text }}>{c.fileName}</span>
              ...
              <div>
                ...
                <button
                    ...
                    try {
                        ...
                        a.href = url;
                        a.download = `${c.fileName.split(".")[0]}_morphix.${c.targetFormat.toLowerCase()}`;
                  ...
                  <span style={{ display: "inline-flex", alignItems: "center", gap: 8, fontSize: 13, color: `${C.text}30` }}>
                    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
      ...
      <footer style={{ background: C.dark, padding: "24px 48px", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
        <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
          <span style={{ color: "#fff", fontWeight: 700, fontSize: 14, textTransform: "uppercase", letterSpacing: "0.04em" }}>Morphix</span>
