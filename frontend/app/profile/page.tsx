...
export default function ProfilePage() {
  ...
  const conversions = JSON.parse(
    typeof window !== "undefined" ? localStorage.getItem("morphix_conversions") || "[]" : "[]"
  );
    ...
    <div style={{ minHeight: "100vh", background: C.base, fontFamily: "Inter, system-ui, sans-serif", color: C.text, display: "flex", flexDirection: "column" }}>
      ...
      <nav style={navStyle}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 24 }}>
          ...
          <div style={{ width: 32, height: 32, borderRadius: "50%", background: C.surface, display: "flex", alignItems: "center", justifyContent: "center", cursor: "pointer" }}>
            ...
            <div style={{ padding: "20px 32px", borderBottom: "0.5px solid #F4F3FB" }}>
              ...
              <div style={{ marginBottom: 16 }}>
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 8 }}>
                  ...
                  <p style={{ fontSize: 11, color: `${C.text}50` }}>
                    {(conversions.length * 0.03).toFixed(1)} GB / 10 GB
                  </p>
                </div>
                <div style={{ height: 4, background: C.low, borderRadius: 99, overflow: "hidden" }}>
                  <div style={{ height: "100%", width: `${Math.min(conversions.length * 3, 100)}%`, background: C.primary, borderRadius: 99 }} />
                </div>
              </div>
